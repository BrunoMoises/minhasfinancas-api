...
import com.bmoises.minhasfinancas.api.dto.AtualizaStatusDTO;
...
public class LancamentoResource {
		...
		try {
			return service.obterPorId(id).map(entity -> {
				...
				return ResponseEntity.ok(lancamento);
					...
					() -> new ResponseEntity("Lancamento não encontrado na bade de Dados.", HttpStatus.BAD_REQUEST));
		} catch (RegraNegocioException e) {
			return ResponseEntity.badRequest().body(e.getMessage());
		}
	}
	...
	public ResponseEntity deletar(@PathVariable("id") Long id) {
		...
		}).orElseGet(() -> new ResponseEntity("Lancamento não encontrado na bade de Dados.", HttpStatus.BAD_REQUEST));
	}
